impl crate::PermissionSdk {
    pub async fn delete(&self, params: crate::params::PermissionSdkDeleteParams) -> Result<String, crate::errors::PermissionSdkDeleteError> {
        ...
        return match (status_code, text.as_str()) {
            ...
            (409, "NOT_FOUND") => Err(Error::NotFound),
